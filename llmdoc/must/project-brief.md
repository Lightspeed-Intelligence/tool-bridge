...
本仓库是 v1(私有仓库 TokenRollAI/tool-bridge)的重写。Lightspeed fork 侧已把生产入口部署在 https://tool-bridge.fantacy.live;v1 可复用资产与重写动机见 [../reference/v1-lessons.md](../reference/v1-lessons.md)。

<!-- TODO(sync): 上游主线视项目为 pre-launch、无正式生产;fork 已上线 fantacy.live,生产口径差异需人工确认 -->
